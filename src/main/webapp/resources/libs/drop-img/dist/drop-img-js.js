...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		this.input			= $(this.element).find('.upload-img-input');
...
//		this.button.edit		= '<div class="btn btn-info btn-edit" title="' + (this.options.editTitle || 'Edit') + '"><i class="glyphicon glyphicon-pencil"></i></div>'
		this.button.saving		= '<div class="btn-saving">' + (this.options.saveLabel || 'Сохранение...') + ' <i class="glyphicon glyphicon-time"></i></div>';
//		this.button.zoomin		= '<div class="btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><img src="" alt="z"></div>';
...
//		this.button.rotateccw	= '<div class="btn btn-default btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="btn-cancel" title="' + (this.options.cancelTitle || 'Отмена') + '"><img src="img/cancel-icon.png" alt="cancel"></div>';
		this.button.done		= '<div class="btn-ok" title="' + (this.options.okTitle || 'Сохранить баннер') + '"><img src="img/done-icon.png" alt="save"></div>';
		this.button.del			= '<div class="btn-del" title="' + (this.options.delTitle || 'Удалить баннер') + '"><img src="img/delete-icon.png" alt="delete"></div>';
	...
	$.html5imageupload.defaults = {
		...
		onAfterZoomImage:	false,
		onAfterInitImage:	false,
		onAfterMoveImage:	false,
		onAfterProcessImage: true,
		onAfterResetImage:	true,
		onAfterCancel:		true,
		onAfterRemoveImage:	false,
		onAfterSelectImage:	true,
