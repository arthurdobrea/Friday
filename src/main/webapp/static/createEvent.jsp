...
<div class="wrapper">
                ...
                <div class="col-lg-12">
                    <div class="white-banner-wrapper">
                        ...
                        <a href="${contextPath}/" id="friday-logo"><img
                                src="${contextPath}/resources/img/friday-logo.png" alt="friday-logo"></a>
    ...
    <div class="event-information-input-block">
                ...
                <div class="file-upload">
                    <div class="image-box">
                        <div class="block-center">
                            <div class="photo-icon"><img class="photo-icon"
                                                         src="${contextPath}/resources/img/photo-icon.png" alt=""></div>
                            <span class="upload-item">загрузить фото</span></div>
                        <img class="event-banner" src="" alt="">
                    </div>
                    <div class="controls"><form:input type="file" path="image" name="image"/></div>
                </div>
            </div>
        ...
        <div class="event-title-input input-style">
            ...
            <div class="input-right-block">
                <div class="input-title">
                    <form:input name="title" path="title" type="text" maxlength="64"/>
        ...
        <div class="event-place-input input-style">
            ...
            <div class="input-right-block">
                <div class="input-place">
                    <form:input name="location" path="location" type="text" maxlength="70"/>
        ...
        <div class="event-select-category-input input-style">
            ...
            <div class="input-right-block">
                <div class="input-category">
                    <form:select name="eventType" path="eventType" class="event-group">
        ...
        <div class="event-end-input input-style">
            ...
            <div class="input-right-block">
                <form:input name="endDate" path="endDate" type='text' class="input-begining-date"/>
                <form:input name="endTime" path="endTime" type="text" class="input-begining-time"/>
            </div>
        </div> <!-- event-end-input -->
        <div class="event-description-input input-style">
            ...
            <div class="input-right-block">
                <form:textarea name="description" path="description" class="input-description"/>
            </div>
        ...
        <div class="button-send">
            <input type="submit" class="button-send-link"/>
        </div>
        </form:form>
