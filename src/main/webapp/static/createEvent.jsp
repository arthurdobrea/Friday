...
<div class="wrapper">
    ...
    <div class="input-event-information-block">
        <div class="event-picture block-style">
            ...
            <div class="image-box" data-width="" data-height="" data-originalsize="false">
        ...
        <div class="input-event-title block-style">
            ...
            <div class="input-event-information">
                <form:input name="title" path="title" type="text" class="input-style" placeholder="Введите название вашего события" maxlength="64"/>
        ...
        <div class="input-event-place block-style">
            ...
            <div class="input-event-information">
                <form:input name="location" path="location"  class="input-style" placeholder="Введите адрес и название места где будет ваше событие"/>
        ...
        <div class="input-event-beginning block-style">
            ...
            <div class="input-event-information">
                <form:input name="startDate" path="startDate" type='text' class="input-begining-date" placeholder="Дата"/>
                <form:input name="startTime" path="startTime" type="text" class="input-begining-time" placeholder="Время"/>
            </div>
        ...
        <div class="field-event-description block-style">
            ...
            <div class="input-event-information">
                <form:textarea name="description" path="description" class="input-style textarea-style"  placeholder="Опишите что будет ждать гостей"/>
            </div>
        </div> <!-- input-event-end -->
        ...
        <div class="footer-dark-wrapper">
            <div class="logo-footer">
                <div class="logo-light-footer">
                    <a href="index.html"><img src="${contextPath}/resources/img/footer-white-friday-logo.png" alt="logo-bottom"></a>
                </div>
            </div>
