            ...
            <div class="chat-content">
                ...
                <div class="user-message">
                    ...
                    <div class="user-message-content">
                        <p class="chat-username">Larisa Luka</p>
                        <p class="chat-message">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non accusamus ex, quo quae placeat fuga ut libero eveniet ratione voluptatum porro perferendis quam nisi officiis illo optio incidunt, aperiam cupiditate?
                        </p>
                        <span>19:00</span>
                    </div>
                </div>
        ...
        +<div class="event-page event-content">
            ...
            <div class="event-information">
                <div class="category-link">
                    категория: <a href="index.html">#Тренинги</a>
                </div>
            </div>
            <div class="event-information">
                <div class="icons">
