...
<div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <c:if test="${pageContext.request.userPrincipal.name != null}">
                        ...
                        <p style="color: white">Welcome ${pageContext.request.userPrincipal.name} | <a onclick="document.forms['logoutForm'].submit()">Logout</a>
                        </p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-banner-wrapper">
                        ...
                        <a href="${contextPath}/" id="friday-logo"><img src="../resources/img/friday-logo.png" alt="friday-logo"></a>
    ...
    <%--<div class="container">--%>
        <%--<div class="row">--%>
            ...
            <%--&lt;%&ndash;$('#datetimepicker2').datetimepicker({&ndash;%&gt;--%>
            <%--&lt;%&ndash;locale: 'ru'&ndash;%&gt;--%>
            <%--&lt;%&ndash;});&ndash;%&gt;--%>
            <%--&lt;%&ndash;});&ndash;%&gt;--%>
            <%--&lt;%&ndash;</script>&ndash;%&gt;--%>
        <%--</div>--%>
