...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/webjars/bootstrap/3.3.5/css/bootstrap.css"/>" type="text/html"/>
...
<script src="<c:url value="/webjars/sockjs-client/0.3.4/sockjs.js" />" type="text/html"></script>
<script src="<c:url value="../resources/js/stomp.js"/>" type="text/javascript"></script>
